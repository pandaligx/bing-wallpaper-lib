...
| 🖼️ **首页网格视图** | 默认展示最近壁纸的瀑布网格，鼠标滚轮触底自动加载更多（无限滚动），右侧可拖动的滚动条 + 右下角"回到顶部"按钮，悬停显示"预览图片"按钮，点击放大预览并可直接下载 / 设为桌面壁纸。 |
...
| 🆕 **一键检测更新** | 启动时自动检测 GitHub 上是否有新版本发布，设置面板也可手动检查，发现新版本后一键下载并自动重启完成升级。 |
| ℹ️ **关于面板** | 设置面板中的"关于"按钮展示当前版本号、感谢开源项目 [niumoo/bing-wallpaper](https://github.com/niumoo/bing-wallpaper) 与本项目仓库链接。 |
...
<p align="center">
  ...
  <br/>
  <sub>首页网格视图：默认展示最近壁纸，支持无限滚动加载更多，左侧导航栏按年 / 月归档历史壁纸</sub>
</p>
...
软件内置检查更新功能（设置面板中），可一键检测并升级到最新版本。
